...
*   **AI-Powered Analysis:** Uses Gemini 3 Pro to understand *what* you changed and *why*.
...
3.  **gemini-chat CLI**: This tool currently acts as a wrapper around the `gemini-chat` command line interface. You must have it installed and available in your system PATH.
    *   *Note: Future versions will integrate the Google SDK directly.*
...
---
*Created by Łukasz Szymański & Gemini AI.*
